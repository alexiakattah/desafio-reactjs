...
import ModalProject from './form/modal-project';
        ...
        <div className="h-full px-3 py-4 flex flex-col justify-between overflow-y-auto bg-white text-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              <a
                href="#"
                className="flex items-center p-2 text-gray-900 rounded-lg   group mb-12"
              >
                <svg
          ...
          <div className="  m-3 bg-gray-200 py-3 rounded-md text-center cursor-pointer">
            <span className="text-gray-800" onClick={handleModal}>
              + Novo projeto
            </span>
          </div>
        </div>
